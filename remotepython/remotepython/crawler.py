...
def crawl_job(url, session) -> dict:
    ...
    #return parse_job(response.text)
...
if __name__ == "__main__":
    print("Hello from CRAWL")
    #crawl('http://www.anishchapagain.com')
    print(crawl('https://www.remotepython.com/jobs/'))
"""
