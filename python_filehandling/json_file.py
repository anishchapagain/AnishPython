...
print("jsonDump Sort+Indent : ",json.dumps(data,sort_keys=True,indent=3)) #indent no of spaces

#TASK: json.dumps(data,sort_keys=True,indent=3) -> file create -> data.json
